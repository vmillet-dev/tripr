...
export function getGlobalErrorMessage(key: string, details?: any) {
  let globalErrorMessages: Record<string, string> = {
    ...
    validUuid: $localize`:@@valid.uuid:Please provide a valid UUID, for example "e567ca9f-9545-3601-a827-ef6b5433df8a".`,
    ...
    INVALID_EMAIL: $localize`:@@valid.email:Please provide a valid e-mail address.`
  };
