...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'ebb3c191-571c-4967-80d4-39b8f472e43e' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('371ed50a-d450-4764-bcaf-ad650b6cf018');
      cy.get(`[data-cy="name"]`).should('have.value', '371ed50a-d450-4764-bcaf-ad650b6cf018');
